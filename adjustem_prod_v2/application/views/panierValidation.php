...
<form action="<?= site_url('PanierValidation/Validation') ?>" form="form-group" enctype="multipart/form-data" method="POST">
    ...
    <div class="col-auto modal-footer">
        <button type="submit" class="btn <?= $config->con_bouton_valider?> ml-auto" id="submit">Valider devis</button>
        <a href="<?= site_url("Panier") ?>" class="btn <?= $config->con_bouton_annuler?> mr-auto">Annuler</a>
    </div>
