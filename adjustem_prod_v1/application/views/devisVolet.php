...
<div class="row" id="lien">
    ...
    <div class="col-3 col-md-2 col-xl-1">
        <a class="btn btn-info" href="<?= site_url('DevisRecap') ?>">continuer</a>
    </div>
    <div class="col-6">
        <a class="btn btn-secondary" href="<?= site_url("DevisVitrage/annulation") ?>">Retour arrière</a>
    </div>
</div>
<hr>
                ...
                foreach ($matieres_lame as $detail) {
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-4" name="vantail">
                        <div class="card MLD20" style="width: 18rem">
                            ...
                            <div class="card-footer text-center h150">
